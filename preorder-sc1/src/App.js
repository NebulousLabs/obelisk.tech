          ...
          <div className="col-md-4 order-section">
            ...
            <div className="coupons-container">
              ...
              <div className="coupon-subtotal-container">
                <div className="coupon-subheading">{formatNumber(quantity)} x SC1</div>
          ...
          <div className="col-md-4 final-cost-section">
            ...
            <div className="terms-check">
              <p>
                ...
                <a href="/assets/img/terms_sc1_batch2.pdf" target="_blank" rel="noopener noreferrer">
    ...
    const handleSubmit = result => {
      ...
      axios
        ...
        .catch(err => {
          ...
          //     this.setState({
          //       checkoutError:
          //         'a user has already ordered an Obelisk SC1 using that email. If you want to modify your order, contact hello@obelisk.tech.',
          //     })
          //   } else {
          //     this.setState({
          //       checkoutError:
